...
export const ENGINE29_SYMBOL_REGISTRY = Object.freeze({
  ...
  DJI: {
    ...
    stressDirection: ENGINE29_STRESS_DIRECTIONS.LOWER,
    required: false,
    primary: polygon("I:DJI"),
    fallback: polygonProxy("DIA", "DJI"),
  },
  ...
  RUT: {
    ...
    subgroup: "SMALL_CAP_BLOCK",
    stressDirection: ENGINE29_STRESS_DIRECTIONS.LOWER,
    required: true,
    primary: polygon("I:RUT"),
    fallback: polygonProxy("IWM", "RUT"),
  },
  RUI: {
    canonicalSymbol: "RUI",
    label: "Russell 1000 Index",
    group: ENGINE29_GROUP_IDS.BREADTH,
    subgroup: "LARGE_CAP_BREADTH_CONTEXT",
    stressDirection: ENGINE29_STRESS_DIRECTIONS.LOWER,
    required: false,
    primary: polygon("I:RUI"),
    fallback: null,
  },
  ...
  SOX: {
    ...
    stressDirection: ENGINE29_STRESS_DIRECTIONS.LOWER,
    required: true,
    primary: polygon("I:SOX"),
    fallback: polygonProxy("SMH", "SOX"),
  },
  XLK: {
    canonicalSymbol: "XLK",
