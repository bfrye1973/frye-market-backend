...
// - QA route: /qa/meter (shows Breadth/Momentum/Rising/Risk-On + Overall light)
// - Health, 404, error
...
// 5-minute sandbox (deltas / nowcast)
app.get("/live/intraday-deltas",(_req, res) => proxyRawJSON(res, rawUrl(PATH_INTRADAY_DELTA)));

// ---------------------------------------------------------------------------
// Diagnostics helpers (so we can verify deployment & routes quickly)
...
// GET /qa/meter → recompute Breadth/Momentum/Rising/Risk-On from sectorCards
// and print Overall10m state/score/components + ema_cross/ema10_dist_pct
